                ...
                <tbody>
                  <tr>
                    <td class="product-thumbnail">
                      <img src="./assets/images/product_02.png" alt="Image" class="img-fluid"></img>
                    </td>
                    ...
                    <td>$49.00</td>
                    <td><Link to="/basket" class="btn btn-primary height-auto btn-sm">X</Link></td>
                  </tr>
    
                  <tr>
                    <td class="product-thumbnail">
                      <img src="./assets/images/product_01.png" alt="Image" class="img-fluid"></img>
                    </td>
                    <td class="product-name">
