...
class Detail extends Component {
    render() { 
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><Link to="/">Home</Link> <span class="mx-2 mb-0">/</span> <Link
              to="/shop">Store</Link> <span class="mx-2 mb-0">/</span> <strong class="text-black">Ibuprofen Tablets, 200mg</strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              <img src="./assets/images/product_07_large.png" alt="Image" class="img-fluid p-5"></img>
            </div>
          </div>
          <div class="col-md-6">
            ...
            <p><Link to="/basket" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Add To Cart</Link></p>
